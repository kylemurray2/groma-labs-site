...
export const metadata = {
    ...
    description: "Advanced satellite interferometry structural health reports for real estate. Powered by Groma Labs.",
};

export default function TerraCheckPage() {
    return (
        <div className="min-h-screen bg-background text-foreground overflow-x-hidden selection:bg-cyan-500/30">
            ...
            <main className="relative pt-0">
                ...
                <div className="relative w-full h-screen min-h-[800px] flex items-center justify-center overflow-hidden">
                    ...
                    <div className="relative z-20 px-6 text-center max-w-5xl mx-auto mt-[-10vh]">
                        ...
                        <p className="text-xl md:text-3xl text-white/90 font-light tracking-wide max-w-2xl mx-auto leading-relaxed drop-shadow-md mb-4">
                            Your World, Verified.
                        </p>
                        <p className="text-white/60 text-lg md:text-xl max-w-2xl mx-auto mb-10">
                            The MRI for Real Estate. We use historical satellite radar to reveal invisible risks beneath the soil.
                        </p>
                        ...
                        <p className="mt-8 text-xs text-white/30">
                            A product of{" "}
                            <a href="/" className="text-primary/50 hover:text-primary/80 transition-colors">Groma Labs</a>
                        </p>
                    </div>
            ...
            <footer className="relative z-20 border-t border-white/5 py-12 bg-black text-center text-sm text-muted-foreground">
                <p>&copy; {new Date().getFullYear()} TerraCheck · A <a href="/" className="text-primary/60 hover:text-primary transition-colors">Groma Labs</a> Product</p>
            </footer>
        </div>
    );
}
